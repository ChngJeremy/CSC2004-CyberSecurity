...
center_window(mainWindow,500, 500)
...
#Calling the function to hide text in audio
def hide_data(sound_path, file_path, output_path):
    global sound, params, n_frames, n_samples, fmt, mask, smallest_byte
    prepare(sound_path)
    # Hiding up to num_lsb bits in each sample of the sound file
...
def recover_data(sound_path, output_path):
    ...
    output_file.close()
#Function To Hide Unhinge Text In Audio File Ends Here--------------------
...
def click_EncodeScreen_Text():
    ...
    def select_Text(value):
        ...
        if value == 1:
            if CheckVar1.get() == 1:
                ...
                Label(TextEncodeFrame6,text="    ",font=("Gothic MS",4),bg=Home_BACK_COL).pack(side=LEFT)
                Label(TextEncodeFrame6,text="Select Text File",font=("Gothic MS",14,BOLD),relief=RAISED,bg=Banner_Colour_1,highlightthickness=3,highlightbackground=Banner_Colour_2).pack(side=LEFT)

                Label(TextEncodeFrame_7,text="    ",font=("Gothic MS",4),bg=Home_BACK_COL).pack(side=LEFT)
                ...
                Label(TextEncodeFrame_7,text="      ",font=("Gothic MS",4),bg=Home_BACK_COL).pack(side=LEFT)
                EncodeFrame_Button3 = Button(TextEncodeFrame_7,text="Select",font=("Gothic MS",12),width=6,height=1,command=choose_Text_file)
            ...
            if CheckVar2.get() == 1:
                ...
                Label(TextEncodeFrame6,text="Please Open Text Editor And\nEnter Your Text",font=("Gothic MS",13),bg=Home_BACK_COL).pack()
                Button(TextEncodeFrame_7,text="Open Text Editor",font=("Gothic MS",12),command=get_Editor_Data).pack()
    ...
    Label(TextEncodeFrame,text="    ",font=("Gothic MS",4),bg=Home_BACK_COL).pack(side=LEFT)
    Label(TextEncodeFrame,text="Carrier Image",font=("Gothic MS",14,BOLD),relief=RAISED,bg=Banner_Colour_1,highlightthickness=3,highlightbackground=Banner_Colour_2).pack(side=LEFT)

    Label(mainWindow,text="  ",font=("Gothic MS",1),bg=Home_BACK_COL).pack()

    TextEncodeFrame_2 = Frame(mainWindow,bg=Home_BACK_COL)
    Label(TextEncodeFrame_2,text="    ",font=("Gothic MS",4),bg=Home_BACK_COL).pack(side=LEFT)
    ...
    Label(TextEncodeFrame_2,text="      ",font=("Gothic MS",4),bg=Home_BACK_COL).pack(side=LEFT)
    EncodeFrame_Button1 = Button(TextEncodeFrame_2,text="Select",font=("Gothic MS",12),width=6,height=1,command=choose_Input_file)
    ...
    Label(TextEncodeFrame3,text="    ",font=("Gothic MS",4),bg=Home_BACK_COL).pack(side=LEFT)
    Label(TextEncodeFrame3,text="Output Image",font=("Gothic MS",14,BOLD),relief=RAISED,bg=Banner_Colour_1,highlightthickness=3,highlightbackground=Banner_Colour_2).pack(side=LEFT)

    Label(mainWindow,text="  ",font=("Gothic MS",1),bg=Home_BACK_COL).pack()

    TextEncodeFrame_4 = Frame(mainWindow,bg=Home_BACK_COL)
    Label(TextEncodeFrame_4,text="    ",font=("Gothic MS",4),bg=Home_BACK_COL).pack(side=LEFT)
    ...
    Label(TextEncodeFrame_4,text="      ",font=("Gothic MS",4),bg=Home_BACK_COL).pack(side=LEFT)
    EncodeFrame_Button2 = Button(TextEncodeFrame_4,text="Select",font=("Gothic MS",12),width=6,height=1,command=choose_Output_file,state=DISABLED)
    EncodeFrame_Button2.pack(side=RIGHT)

    TextEncodeFrame_4.pack(side=TOP,anchor=W)

    Label(mainWindow,text="  ",font=("Gothic MS",4),bg=Home_BACK_COL).pack()

    TextEncodeFrame_5 = Frame(mainWindow,bg=Home_BACK_COL)

    C1 = Checkbutton(TextEncodeFrame_5,bg=Home_BACK_COL,activebackground=Home_BACK_COL,state=DISABLED, text = "Select A Text File",font=("Gothic MS",13) ,command=lambda:select_Text(1),variable = CheckVar1,onvalue = 1, offvalue = 0,width=15)
    C1.pack(side=LEFT)
    C2 = Checkbutton(TextEncodeFrame_5,bg=Home_BACK_COL,activebackground=Home_BACK_COL,state=DISABLED, text = "Enter Text Manually",font=("Gothic MS",13),command=lambda:select_Text(2), variable = CheckVar2,onvalue = 1, offvalue = 0,width=15)
    C2.pack(side=RIGHT)
    TextEncodeFrame_5.pack()

    Label(mainWindow,text="  ",font=("Gothic MS",50),bg=Home_BACK_COL).pack()
    ...
    EncodeFrame_Button4 = Button(TextEncodeFrame_8,text="Back",font=("Gothic MS",14,BOLD,ITALIC),width=12,bg=ButtonColour_2,command=back_Btn_Fun)
    EncodeFrame_Button4.pack(side=LEFT)
    Label(TextEncodeFrame_8,text="      ",font=("Gothic MS",10),bg=Home_BACK_COL).pack(side=LEFT)
    EncodeFrame_Button5 = Button(TextEncodeFrame_8,text="Encode",font=("Gothic MS",14,BOLD,ITALIC),width=12,state=DISABLED,bg=ButtonColour_1,command=main_Text_encode)
...
def click_Audio_Encode_Screen():
    ...
    def select_Text(value):
        ...
        if value == 1:
            if CheckVar1.get() == 1:
                ...
                Label(AudioEncodeFrame6,text="    ",font=("Gothic MS",4),bg=Home_BACK_COL).pack(side=LEFT)
                Label(AudioEncodeFrame6,text="Select Text File",font=("Gothic MS",14,BOLD),relief=RAISED,bg=Banner_Colour_1,highlightthickness=3,highlightbackground=Banner_Colour_2).pack(side=LEFT)

                Label(AudioEncodeFrame_7,text="    ",font=("Gothic MS",4),bg=Home_BACK_COL).pack(side=LEFT)
                ...
                Label(AudioEncodeFrame_7,text="      ",font=("Gothic MS",4),bg=Home_BACK_COL).pack(side=LEFT)
                EncodeFrame_Button3 = Button(AudioEncodeFrame_7,text="Select",font=("Gothic MS",12),width=6,height=1,command=choose_Text_file)
                EncodeFrame_Button3.pack(side=RIGHT)
            ...
            if CheckVar2.get() == 1:
                ...
                Button(AudioEncodeFrame_7,text="Open Text Editor",font=("Gothic MS",12),command=get_Editor_Data).pack()
    ...
    Label(AudioEncodeFrame,text="    ",font=("Gothic MS",4),bg=Home_BACK_COL).pack(side=LEFT)
    Label(AudioEncodeFrame,text="Carrier Audio",font=("Gothic MS",14,BOLD),relief=RAISED,bg=Banner_Colour_1,highlightthickness=3,highlightbackground=Banner_Colour_2).pack(side=LEFT)

    Label(mainWindow,text="  ",font=("Gothic MS",1),bg=Home_BACK_COL).pack()

    AudioEncodeFrame_2 = Frame(mainWindow,bg=Home_BACK_COL)
    Label(AudioEncodeFrame_2,text="    ",font=("Gothic MS",4),bg=Home_BACK_COL).pack(side=LEFT)
    ...
    Label(AudioEncodeFrame_2,text="      ",font=("Gothic MS",4),bg=Home_BACK_COL).pack(side=LEFT)
    EncodeFrame_Button1 = Button(AudioEncodeFrame_2,text="Select",font=("Gothic MS",12),width=6,height=1,command=choose_Input_file)
    EncodeFrame_Button1.pack(side=RIGHT)
    ...
    Label(AudioEncodeFrame3,text="    ",font=("Gothic MS",4),bg=Home_BACK_COL).pack(side=LEFT)
    Label(AudioEncodeFrame3,text="Output Audio",font=("Gothic MS",14,BOLD),relief=RAISED,bg=Banner_Colour_1,highlightthickness=3,highlightbackground=Banner_Colour_2).pack(side=LEFT)

    Label(mainWindow,text="  ",font=("Gothic MS",1),bg=Home_BACK_COL).pack()

    AudioEncodeFrame_4 = Frame(mainWindow,bg=Home_BACK_COL)
    Label(AudioEncodeFrame_4,text="    ",font=("Gothic MS",4),bg=Home_BACK_COL).pack(side=LEFT)
    ...
    Label(AudioEncodeFrame_4,text="      ",font=("Gothic MS",4),bg=Home_BACK_COL).pack(side=LEFT)
    EncodeFrame_Button2 = Button(AudioEncodeFrame_4,text="Select",font=("Gothic MS",12),width=6,height=1,command=choose_Output_file,state=DISABLED)
    EncodeFrame_Button2.pack(side=RIGHT)
    ...
    C1 = Checkbutton(AudioEncodeFrame_5,activebackground=Home_BACK_COL,bg=Home_BACK_COL,state=DISABLED, text = "Select A Text File",font=("Gothic MS",13) ,command=lambda:select_Text(1),variable = CheckVar1,onvalue = 1, offvalue = 0,width=15)
    C1.pack(side=LEFT)
    C2 = Checkbutton(AudioEncodeFrame_5,activebackground=Home_BACK_COL,bg=Home_BACK_COL,state=DISABLED, text = "Enter Text Manually",font=("Gothic MS",13),command=lambda:select_Text(2), variable = CheckVar2,onvalue = 1, offvalue = 0,width=15)
    C2.pack(side=RIGHT)
    ...
    EncodeFrame_Button4 = Button(AudioEncodeFrame_8,text="Back",font=("Gothic MS",14,BOLD,ITALIC),width=12,bg=ButtonColour_2,command=back_Btn_Fun)
    EncodeFrame_Button4.pack(side=LEFT)
    Label(AudioEncodeFrame_8,text="      ",font=("Gothic MS",10),bg=Home_BACK_COL).pack(side=LEFT)
...
def click_Image_Encode_Screen():
    ...
    Label(ImageEncodeFrame_5,text="Hidden Image File",font=("Gothic MS",14,BOLD),relief=RAISED,bg=Banner_Colour_1,highlightthickness=3,highlightbackground=Banner_Colour_2).pack(side=LEFT)
...
def click_DecodeScreen_Text():
    ...
    Label(mainWindow,text=" ",font=("Gothic MS",12),bg=Home_BACK_COL).pack()

    TextDecodeFrame = Frame(mainWindow,bg=Home_BACK_COL)
    TextDecodeFrame.pack(side=TOP,anchor=W)
    Label(TextDecodeFrame,text="    ",font=("Gothic MS",4),bg=Home_BACK_COL).pack(side=LEFT)
    Label(TextDecodeFrame,text="Encoded Image",font=("Gothic MS",14,BOLD),relief=RAISED,bg=Banner_Colour_1,highlightthickness=3,highlightbackground=Banner_Colour_2).pack(side=LEFT)

    Label(mainWindow,text="  ",font=("Gothic MS",1),bg=Home_BACK_COL).pack()

    TextDecodeFrame_2 = Frame(mainWindow,bg=Home_BACK_COL)
    Label(TextDecodeFrame_2,text="    ",font=("Gothic MS",4),bg=Home_BACK_COL).pack(side=LEFT)
    ...
    Label(TextDecodeFrame_2,text="      ",font=("Gothic MS",4),bg=Home_BACK_COL).pack(side=LEFT)
    DecodeFrame_Button1 = Button(TextDecodeFrame_2,text="Select",font=("Gothic MS",12),width=6,height=1,command=choose_Input_file)
    ...
    Label(TextDecodeFrame3,text="    ",font=("Gothic MS",4),bg=Home_BACK_COL).pack(side=LEFT)
    Label(TextDecodeFrame3,text="Output Folder",font=("Gothic MS",14,BOLD),relief=RAISED,bg=Banner_Colour_1,highlightthickness=3,highlightbackground=Banner_Colour_2).pack(side=LEFT)

    Label(mainWindow,text="  ",font=("Gothic MS",1),bg=Home_BACK_COL).pack()

    TextDecodeFrame_4 = Frame(mainWindow,bg=Home_BACK_COL)
    Label(TextDecodeFrame_4,text="    ",font=("Gothic MS",4),bg=Home_BACK_COL).pack(side=LEFT)
    ...
    Label(TextDecodeFrame_4,text="      ",font=("Gothic MS",4),bg=Home_BACK_COL).pack(side=LEFT)
    DecodeFrame_Button2 = Button(TextDecodeFrame_4,text="Select",font=("Gothic MS",12),width=6,height=1,command=choose_Output_file,state=DISABLED)
    ...
    DecodeFrame_Button3 = Button(TextDecodeFrame_6,text="Open Text Editor",font=("Gothic MS",12),command=preview_In_text_editor,state=DISABLED)
    ...
    DecodeFrame_Button4 = Button(TextDecodeFrame_8,text="Back",font=("Gothic MS",14,BOLD,ITALIC),width=12,bg=ButtonColour_2,command=back_Btn_Fun)
    DecodeFrame_Button4.pack(side=LEFT)
    Label(TextDecodeFrame_8,text="      ",font=("Gothic MS",10),bg=Home_BACK_COL).pack(side=LEFT)
    DecodeFrame_Button5 = Button(TextDecodeFrame_8,text="Decode",font=("Gothic MS",14,BOLD,ITALIC),width=12,state=DISABLED,bg=ButtonColour_1,command=main_Text_Decode)
...
def click_DecodeScreen_Audio():
    ...
    Label(AudioDecodeFrame,text="    ",font=("Gothic MS",4),bg=Home_BACK_COL).pack(side=LEFT)
    Label(AudioDecodeFrame,text="Encoded Audio",font=("Gothic MS",14,BOLD),relief=RAISED,bg=Banner_Colour_1,highlightthickness=3,highlightbackground=Banner_Colour_2).pack(side=LEFT)

    Label(mainWindow,text="  ",font=("Gothic MS",1),bg=Home_BACK_COL).pack()

    AudioDecodeFrame_2 = Frame(mainWindow,bg=Home_BACK_COL)
    Label(AudioDecodeFrame_2,text="    ",font=("Gothic MS",4),bg=Home_BACK_COL).pack(side=LEFT)
    ...
    Label(AudioDecodeFrame_2,text="      ",font=("Gothic MS",4),bg=Home_BACK_COL).pack(side=LEFT)
    DecodeFrame_Button1 = Button(AudioDecodeFrame_2,text="Select",font=("Gothic MS",12),width=6,height=1,command=choose_Input_file)
    DecodeFrame_Button1.pack(side=RIGHT)
    ...
    Label(AudioDecodeFrame3,text="    ",font=("Gothic MS",4),bg=Home_BACK_COL).pack(side=LEFT)
    Label(AudioDecodeFrame3,text="Output Folder",font=("Gothic MS",14,BOLD),relief=RAISED,bg=Banner_Colour_1,highlightthickness=3,highlightbackground=Banner_Colour_2).pack(side=LEFT)

    Label(mainWindow,text="  ",font=("Gothic MS",1),bg=Home_BACK_COL).pack()

    AudioDecodeFrame_4 = Frame(mainWindow,bg=Home_BACK_COL)
    Label(AudioDecodeFrame_4,text="    ",font=("Gothic MS",4),bg=Home_BACK_COL).pack(side=LEFT)
    ...
    Label(AudioDecodeFrame_4,text="      ",font=("Gothic MS",4),bg=Home_BACK_COL).pack(side=LEFT)
    DecodeFrame_Button2 = Button(AudioDecodeFrame_4,text="Select",font=("Gothic MS",12),width=6,height=1,command=choose_Output_file,state=DISABLED)
    DecodeFrame_Button2.pack(side=RIGHT)
    ...
    DecodeFrame_Button3 = Button(AudioDecodeFrame_6,text="Open Text Editor",font=("Gothic MS",12),command=preview_In_text_editor,state=DISABLED)
    DecodeFrame_Button3.pack()
    ...
    DecodeFrame_Button4 = Button(AudioDecodeFrame_8,text="Back",font=("Gothic MS",14,BOLD,ITALIC),width=12,bg=ButtonColour_2,command=back_Btn_Fun)
    DecodeFrame_Button4.pack(side=LEFT)
    Label(AudioDecodeFrame_8,text="      ",font=("Gothic MS",10),bg=Home_BACK_COL).pack(side=LEFT)
    DecodeFrame_Button5 = Button(AudioDecodeFrame_8,text="Decode",font=("Gothic MS",14,BOLD,ITALIC),width=12,state=DISABLED,bg=ButtonColour_1,command=main_Text_Decode)
    DecodeFrame_Button5.pack(side=LEFT)
...
def click_DecodeScreen_Image():
    ...
    Label(ImageDecodeFrame,text="    ",font=("Gothic MS",4),bg=Home_BACK_COL).pack(side=LEFT)
    Label(ImageDecodeFrame,text="Encoded Image",font=("Gothic MS",14,BOLD),relief=RAISED,bg=Banner_Colour_1,highlightthickness=3,highlightbackground=Banner_Colour_2).pack(side=LEFT)

    Label(mainWindow,text="  ",font=("Gothic MS",1),bg=Home_BACK_COL).pack()

    ImageDecodeFrame_2 = Frame(mainWindow,bg=Home_BACK_COL)
    Label(ImageDecodeFrame_2,text="    ",font=("Gothic MS",4),bg=Home_BACK_COL).pack(side=LEFT)
    ...
    Label(ImageDecodeFrame_2,text="      ",font=("Gothic MS",4),bg=Home_BACK_COL).pack(side=LEFT)
    DecodeFrame_Button1 = Button(ImageDecodeFrame_2,text="Select",font=("Gothic MS",12),width=6,height=1,command=choose_Input_file)
    DecodeFrame_Button1.pack(side=RIGHT)
    ...
    Label(ImageDecodeFrame3,text="    ",font=("Gothic MS",4),bg=Home_BACK_COL).pack(side=LEFT)
    Label(ImageDecodeFrame3,text="Output Folder",font=("Gothic MS",14,BOLD),relief=RAISED,bg=Banner_Colour_1,highlightthickness=3,highlightbackground=Banner_Colour_2).pack(side=LEFT)

    Label(mainWindow,text="  ",font=("Gothic MS",1),bg=Home_BACK_COL).pack()

    ImageDecodeFrame_4 = Frame(mainWindow,bg=Home_BACK_COL)
    Label(ImageDecodeFrame_4,text="    ",font=("Gothic MS",4),bg=Home_BACK_COL).pack(side=LEFT)
    ...
    Label(ImageDecodeFrame_4,text="      ",font=("Gothic MS",4),bg=Home_BACK_COL).pack(side=LEFT)
    DecodeFrame_Button2 = Button(ImageDecodeFrame_4,text="Select",font=("Gothic MS",12),width=6,height=1,command=choose_Output_file,state=DISABLED)
    DecodeFrame_Button2.pack(side=RIGHT)
    ...
    DecodeFrame_Button3 = Button(ImageDecodeFrame_6,text="Open In Image Viewer",font=("Gothic MS",12),command=preview_Image,state=DISABLED)
    DecodeFrame_Button3.pack()
    ...
    DecodeFrame_Button4 = Button(ImageDecodeFrame_8,text="Back",font=("Gothic MS",14,BOLD,ITALIC),width=12,bg=ButtonColour_2,command=back_Btn_Fun)
    DecodeFrame_Button4.pack(side=LEFT)
    Label(ImageDecodeFrame_8,text="      ",font=("Gothic MS",10),bg=Home_BACK_COL).pack(side=LEFT)
    DecodeFrame_Button5 = Button(ImageDecodeFrame_8,text="Decode",font=("Gothic MS",14,BOLD,ITALIC),width=12,state=DISABLED,bg=ButtonColour_1,command=main_Text_Decode)
    DecodeFrame_Button5.pack(side=LEFT)
...
def show_About():
    ...
    Label(mainWindow,text=" ",font=("Gothic MS",2),bg=Home_BACK_COL).pack()
    About_Banner = Label(About_banner_Frame,text=" Steganography\n Program ",font=("Gothic MS",35,ITALIC,UNDERLINE),bg=Banner_Colour_1)
    About_Banner.pack()
    Label(About_banner_Frame,text=" ",font=("Gothic MS",2),bg=Banner_Colour_1).pack()
    About_Description = Label(About_banner_Frame,text="Work in Progress....",font=("Gothic MS",14,ITALIC),bg=Banner_Colour_1)
    About_Description.pack()
    Label(About_banner_Frame,text=" ",font=("Gothic MS",4,ITALIC),bg=Banner_Colour_1).pack()
    About_Description2 = Label(About_banner_Frame,text=" Developed By ",font=("Gothic MS",14,ITALIC,UNDERLINE),bg=Banner_Colour_1)
    About_Description2.pack()
    About_Description3 = Label(About_banner_Frame,text="CSC 2004 -Cyber Security Fundementals \n Team 03",font=("Gothic MS",14),bg=Banner_Colour_1)
...
def show_EncodeScreen():
    ...
    Label(encode_banner_Frame,text=" ",font=("Gothic MS",1,ITALIC),bg=Banner_Colour_1).pack()
    ...
    Label(EncodeFrame,text=" ",font=("Gothic MS",4),bg=Home_BACK_COL).pack()
    Image_button = Button(EncodeFrame,text="Image",font=("Gothic MS",14,BOLD,ITALIC),width=12,command=click_Image_Encode_Screen,bg=ButtonColour_1)
    Image_button.pack()
    CreateToolTip(Image_button, text = "Encode An Image File\nBehind An Image File")
    Label(EncodeFrame,text=" ",font=("Gothic MS",4),bg=Home_BACK_COL).pack()
    Back_button = Button(EncodeFrame,text="Back",font=("Gothic MS",14,BOLD,ITALIC),width=12,command=show_HomeScreen,bg=ButtonColour_2)
    Back_button.pack()
...
def show_DecodeScreen():
    ...
    Label(Decode_banner_Frame,text=" ",font=("Gothic MS",1,ITALIC),bg=Banner_Colour_1).pack()
    ...
    Label(DecodeFrame,text=" ",font=("Gothic MS",8),bg=Home_BACK_COL).pack()
    Text_button = Button(DecodeFrame,text="Text/Text File",font=("Gothic MS",14,BOLD,ITALIC),width=12,command=click_DecodeScreen_Text,bg=ButtonColour_1)
    Text_button.pack()
    CreateToolTip(Text_button, text = "Extract Text or Text Document\nFrom Image File")
    Label(DecodeFrame,text=" ",font=("Gothic MS",4),bg=Home_BACK_COL).pack()
    Audio_button = Button(DecodeFrame,text="Audio",font=("Gothic MS",14,BOLD,ITALIC),width=12,command=click_DecodeScreen_Audio,bg=ButtonColour_1)
    Audio_button.pack()
    CreateToolTip(Audio_button, text = "Extract Text or Text Document\nFrom Audio File")
    Label(DecodeFrame,text=" ",font=("Gothic MS",4),bg=Home_BACK_COL).pack()
    Image_button = Button(DecodeFrame,text="Image",font=("Gothic MS",14,BOLD,ITALIC),width=12,command=click_DecodeScreen_Image,bg=ButtonColour_1)
    Image_button.pack()
    CreateToolTip(Image_button, text = "Extract Encoded Image\nFrom Image File")
    Label(DecodeFrame,text=" ",font=("Gothic MS",4),bg=Home_BACK_COL).pack()
    Back_button = Button(DecodeFrame,text="Back",font=("Gothic MS",14,BOLD,ITALIC),width=12,command=show_HomeScreen,bg=ButtonColour_2)
    Back_button.pack()
    CreateToolTip(Back_button, text = "Back To Home Screen")
...
def exit_CON():
    a = messagebox.askquestion("Exit Window","Are you sure you want to exit?")
    if a == "yes":
        mainWindow.destroy()
...
def show_HomeScreen():
    ...
    Label(home_banner_Frame,text=" ",font=("Gothic MS",1,ITALIC),bg=Banner_Colour_1).pack()
    Home_Banner = Label(home_banner_Frame,text="Steganography\nTool ",font=("Gothic MS",35,ITALIC,UNDERLINE),bg=Banner_Colour_1)
    Home_Banner.pack()
    Label(home_banner_Frame,text=" ",font=("Gothic MS",2),bg=Banner_Colour_1).pack()
    Home_Description = Label(home_banner_Frame,text="A current Work in Progress...\n",font=("Gothic MS",13,ITALIC),bg=Banner_Colour_1)
    Home_Description.pack()
    home_banner_Frame.pack()


    Label(homeFrame,text=" ",font=("Gothic MS",8),bg=Home_BACK_COL).pack()
    Encode_button = Button(homeFrame,text="Encode",font=("Gothic MS",14,BOLD,ITALIC),width=11,bg=ButtonColour_1,command=show_EncodeScreen)
    Encode_button.pack()
    Label(homeFrame,text=" ",font=("Gothic MS",4),bg=Home_BACK_COL).pack()
    Decode_button = Button(homeFrame,text="Decode",font=("Gothic MS",14,BOLD,ITALIC),width=11,bg=ButtonColour_1,command=show_DecodeScreen)
    Decode_button.pack()
    Label(homeFrame,text=" ",font=("Gothic MS",4),bg=Home_BACK_COL).pack()
    About_button = Button(homeFrame,text="About",font=("Gothic MS",14,BOLD,ITALIC),width=11,bg=ButtonColour_1,command=show_About)
    About_button.pack()
    Label(homeFrame,text=" ",font=("Gothic MS",4),bg=Home_BACK_COL).pack()
    Exit_button = Button(homeFrame,text="Exit",font=("Gothic MS",14,BOLD,ITALIC),width=11,bg=ButtonColour_2,command=exit_CON)
    Exit_button.pack()
    homeFrame.pack()
